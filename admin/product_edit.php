...
<div class="admin-content-right">
    <div class="product-add-content">
        ...
        <form action="product_edit_procesc.php" method="POST" enctype="multipart/form-data">
            ...
            <select required="required" name="nha_san_xuat  " id="nhaxuatban_id">
                <option value=""><?php echo $truy_van['nha_san_xuat'] ?></option>
                <?php 
                foreach ($ket_qua as $tung_san_pham){ ?>
                <option value=""><?php 
                echo $tung_san_pham['nha_san_xuat']; ?></option>
            <?php } ?>
            </select>

            <label for="">Giá sản phẩm<span style="color: red;">*</span></label> <br>
            <input required type="text" value="<?php echo $truy_van['ten'] ?>" name="gia"> <br>
            <label for="">Mô tả<span style="color: red;">*</span></label> <br>
            <textarea class="ckeditor" required name="mota" cols="60" rows="5"> <?php echo $truy_van['mo_ta'] ?></textarea><br>
            <label for="">Ảnh Sản phẩm<span style="color: red;">*</span></label> <br>
            <input required type="text" name="anh" value=""> <br>
